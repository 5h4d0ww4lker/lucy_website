...
foreach ($company as $original_company) {
    ...
    ?>
			...
			<?php echo form_open_multipart('Admin/AdminController/update_service');?>
              <div class="box-body">
  ...
  <div class="form-group">
                ...
                <label>For</label><br/>
                <?php if($local == "on") { ?>
              <input type="checkbox" checked name="local">Local
              ...
              <?php } ?>
                <?php if($import == "on") { ?>
              <input type="checkbox" checked name="import">Import
               <?php } ?>
                <?php if($import != "on") { ?>
              <input type="checkbox"  name="import">Import

              <?php } ?>
              <?php if($export == "on") { ?>
              <input type="checkbox" checked name="export">Export
               <?php } ?>
                <?php if($export != "on") { ?>
              <input type="checkbox"  name="export">Export
