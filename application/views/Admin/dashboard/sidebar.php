      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../forms/general.html"><i class="fa fa-circle-o"></i> Create</a></li>
            <li><a href="../forms/advanced.html"><i class="fa fa-circle-o"></i> List</a></li>
         ...
         <li class="treeview">
          ...
          <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Home Page Articles</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          ...
          <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Home Page Sliders</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Customer Requests</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>