  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Testmonal</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
			...
			<?php echo form_open_multipart('Admin/AdminController/save_testimonial');?>
              <div class="box-body">
               ...
               <div class="form-group">
                  <label for="exampleInputEmail1">Testimonial From</label>
                  <input type="text"  name="testimony_from" class="form-control" id="exampleInputEmail1" placeholder="Enter Name">
                </div>
