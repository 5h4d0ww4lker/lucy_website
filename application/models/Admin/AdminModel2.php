   ...
   public function get_main_company()
        ...
        public function get_testimonials($company_id)
    {
        ...
        return $query->result_object();
          ...
          public function get_galleries($company_id)
    {
...
//COMPANY AREA
    ...
    public function add_company($img_path)
    {
...
public function update_company($company_id, $img_path)
    {
...
public function update_service($service_id, $img_path)
    {
...
public function update_product($product_id, $path)
{
...
public function update_about_us($about_us_id, $path)
{
...
public function update_contact_us($contact_us_id, $img_path)
{
...
//END CONTACT US AREA
 ...
 public function update_team($team_id, $path)
 {
 ...
 public function update_home_page_articles($article_id, $path)
 {
 ...
 //END ARTICLES US AREA
  ...
  public function update_gallery($gallery_id, $path)
  {
  ...
  public function update_slider($slider_id, $path)
  {
  ...
  public function update_page($page_id, $path)
  {
   ...
   public function update_page_content($content_id, $path)
  {
