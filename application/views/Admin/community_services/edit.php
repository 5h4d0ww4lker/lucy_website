  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Community Service</li>
      </ol>
    </section>
...
foreach ($community_services as $community_service) {
	$community_service_id = $community_service['community_service_id'];
        $title = $community_service['title'];
        $company_id = $community_service['company_id'];
        $description = $community_service['description'];
        $visiblity = $community_service['visiblity'];
         
        $image_url = $community_service['image_url'];
         $src = $image_url;
...
foreach ($company as $original_company) {
    ...
    ?>
			...
			<?php echo form_open_multipart('Admin/AdminController/update_community_service');?>
              <div class="box-body">
                <div class="form-group">
				<input type="hidden" name = "community_service_id" value = "<?= $community_service_id ?>"
                  <label for="exampleInputEmail1">Community Service Name</label>
                  <input type="text" value="<?= $title ?>"  name="title" class="form-control" id="exampleInputEmail1" placeholder="Enter Community Service Name">
                </div>
                 <div class="form-group">
                <label></label>
  ...
  <div class="form-group">
        ...
        <div class="box box-primary">
            ...
            <div class="box-header">
              <h3 class="box-title">Community Service Description
